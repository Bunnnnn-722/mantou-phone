...
const API=(()=>{
  ...
  async function exec(t){
    ...
    if(typeof Scenes!=='undefined')Scenes.busy(1);else if(typeof Sky!=='undefined')Sky.busy(1); // 场景装帧:有请求在跑,星空拉星轨/雨下急/雪飘快
    try{
    ...
    }finally{st.run[t.ch]--;if(typeof Scenes!=='undefined')Scenes.busy(-1);else if(typeof Sky!=='undefined')Sky.busy(-1);renderQ();persist();pump(t.ch)}
  }
